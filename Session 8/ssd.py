...
Original file is located at
    https://colab.research.google.com/drive/1Bsuq9o-7WJaGs5gRYPUXRE2bLlul-SCc
...
of different blocks in SSD. To begin with, we discuss how to implement
...
(Lin et al., 2017) given hyperparameters $\gamma > 0$
